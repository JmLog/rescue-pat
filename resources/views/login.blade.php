                ...
                <div class="col-lg-6 px-lg-4">
                    <div class="card">
                        ...
                        <div class="card-footer px-lg-5 py-lg-4">
                            <div class="text-sm text-muted">Don't have an account? <a href="register.html">Register</a>.</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-5 ms-xl-auto px-lg-4 text-center text-primary"><img class="img-fluid mb-4" width="300" src="images/drawkit-illustration.svg" alt="" style="transform: rotate(10deg)">
